...
print('This is the dice generation application. It will now generate real and fake datasets, and export them into three files. \n The raw files will contain the datasets before merging and shuffling. The balanced file is fed to the Neural Network later on.')
# In[3]:
